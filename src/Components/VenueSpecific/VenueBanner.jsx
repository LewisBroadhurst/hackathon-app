...
const VenueBanner = () => {
  return (
    <section className='flex flex-col gap-4 justify-between items-center pb-6 border-b border-neutral mb-5 xl:flex-row'>
      <section className='flex flex-col items-start gap-2'>
        <div className='flex flex-col items-start gap-2'>
          <h1 className='text-3xl xl:text-4xl font-bold'>Five Star Bowling Alley</h1>

          <div className='flex flex-row gap-4 text-sm xl:text-xl'>
      ...
      <section className='w-5/6 xl:w-[500px]'>
        <VenueCarousel />
      </section>
    </section>
  )
