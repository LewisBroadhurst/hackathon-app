  ...
  return (
    <section className="border-b border-cMono500 pb-5">
        <div className="text-cMono800 flex flex-col items-center">
            ...
            <nav className="mt-4">
                <ul className="flex flex-row items-center flex-wrap gap-2 content-around text-md md:text-lg">
                    <li className="px-2 py-1 bg-cMono200 rounded-lg">Home</li>
                    <li className="px-2 py-1 bg-cMono200 rounded-lg">Events</li>
                    <li className="px-2 py-1 bg-cMono200 rounded-lg">
